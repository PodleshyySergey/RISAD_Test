...
//    выбор года программы работ (!!! для проходжения теста создания программы работ (testCreateProgramWorkFKU) необходимо указать год, в котором программа работ еще не создавалась)
    public String YearProgramWork = "2035";
...
//    Тестовые данные для создания и редактирования объекта программы работ
    ObjectPWtopCreate objectPWCreate1 = new ObjectPWtopCreate("ФКУ Упрдор «Енисей»", "Республика Тыва", "Устройство защитных слоев", "11", "22", "33", "44", "24", YearProgramWork);
    ObjectPWtopEdit objectPWEdit1 = new ObjectPWtopEdit("Устройство поверхностной обработки", "12", "32", "43", "45", "26", YearProgramWork);
//    Тестовые данные для добавления и редактирования корректировки
    Correction correctionCreate = new Correction("На вновь начинаемый объект", "09.02.2020", "123");
    Correction correctionEdit = new Correction("Перераспределение средств с", "19.03.2022", "1321");
//    Тестовые данные для постатей
    SubArticle article226RPD = new SubArticle("226", "Разработка проектной документации", "200");
    SubArticle article226PZ = new SubArticle("226", "Прочие затраты", "200");
//    Тестовые данные для создания и редактирования объекта работ (вкладка "Объекты работ")
    ObjectWork objectWorkCreate = new ObjectWork("ФКУ Упрдор «Енисей»", "'Республика Тыва'", "\"Енисей\" Красноярск - Абакан - Кызыл - Чадан - Хандагайты - граница с Монголией'", "12", "111", "21", "222", "Ремонт 12.12.2012", "444", "1 категоря");
    ObjectWork objectWorkEdit = new ObjectWork("ФКУ Упрдор «Енисей»", "'Республика Тыва'", "\"Енисей\" Красноярск - Абакан - Кызыл - Чадан - Хандагайты - граница с Монголией'", "21", "222", "32", "333", "Ремонт 12.12.2014", "555", "0 категоря");
